...
-- Create policies to allow public read access (for leaderboard)
...
-- Allow public insert for new users and activities
CREATE POLICY "Allow public insert to users" ON users
    FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow public insert to activities" ON activities
    FOR INSERT WITH CHECK (true);

-- Allow public update for user points
